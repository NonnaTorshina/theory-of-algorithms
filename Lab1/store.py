...
def store_totals():
    ...
    return Table_quantity, Sofa_quantity, Chair_quantity, Table_cost, Sofa_cost, Chair_cost

def demo():
    Table_quantity, Sofa_quantity, Chair_quantity, Table_cost, Sofa_cost, Chair_cost = store_totals()
    print("Стол -", Table_quantity , "шт,", "стоимость",Table_cost)
    print("Диван -", Sofa_quantity , "шт,", "стоимость",Sofa_cost)
    print("Стул -", Chair_quantity , "шт,", "стоимость",Chair_cost)